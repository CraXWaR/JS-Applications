function attachEvents() {
    ...
    const currDivFChild = `<div class="label">Current conditions</div>`;
    const weatherMap = {
        'Sunny': '&#x2600;',
        'Partly sunny': '&#x26C5;',
        'Overcast': '&#x2601;',
    ...
    function currentWeatherRender(data) {
        const currCity = data.find(e => e.name == cityEl.value);
    ...
    function createCurrentWeather(city) {
        const parentEl = div('', ['className', 'forecasts']);
        ...
        parentEl.appendChild(spanSymbol);
        parentEl.appendChild(spanParent);
        currDiv.appendChild(parentEl);
    }
    ...
    function renderWeather(city) {
        currDiv.innerHTML = currDivFChild;
    ...
    function currentTimeError() {
        ...
        currDiv.appendChild(parentElem);
    }
